<template>
<!-- 人员管理界面 -->
    <div id="schoolYearSetting">
        <div v-show="first">
            <div class="title">学年列表</div>
            <div class="btns">
                <button class="bt1" @click="newF()">新建学年</button>
                <div>
        ...
        <div v-show="newFirst" class="sides">
            <div class="xjtz">新建学年</div>
            <div class="centerstyle">
                <div style="margin-left:66px;margin-top:40px;font-size:14px;">
                    <span style="color:red;">*</span><span>学年名称：</span>
                    <Input v-model="value" placeholder="请输入学年名称" style="width: 193px;margin-left:30px;"/>
                    <p style="margin-top:19px;"></p>
                    <span style="color:red;">*</span><span>学年代码：</span>
                    <Input v-model="value" placeholder="请输入学年代码" style="width: 193px;margin-left:30px;"/>
                    <p style="margin-top:19px;"></p>
                    <span style="color:red;">*</span><span>学年负责人：</span>
        ...
        <div class="xyxm" v-show="looks">
            <div class="topxyxm">
                ...
                <div style="margin-top:36px;font-size:14px;margin-left:3px">
                    <span>学年名称：</span><span style="margin-left:60px;font-weight:600;">{{model1}}</span>
                </div>
                <div style="margin-top:36px;font-size:14px;margin-left:3px">
                    <span>学年代码：</span><span style="margin-left:60px;font-weight:600;">{{model1}}</span>
                </div>
                <div style="margin-top:36px;font-size:14px;margin-left:3px">
                    <span>学年负责人：</span><span style="margin-left:46px;font-weight:600;">{{model1}}</span>
                </div>
