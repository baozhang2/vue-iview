<template>
  ...
  <div id="gasData">
    <div v-show="first">
      ...
      <div class="btns">
        <button class="bt1" @click="newF()">新建学院</button>
        <div>
    ...
    <div v-show="newFirst" class="sides">
      <div class="xjtz">新建学院</div>
      <div class="centerstyle">
        <div style="margin-left:66px;margin-top:40px;font-size:14px;">
          <span style="color:red;">*</span>
          <span>学院名称：</span>
          <Input v-model="value" placeholder="请输入学院名称" style="width: 193px;margin-left:30px;" />
          <p style="margin-top:19px;"></p>
          <span style="color:red;">*</span>
          <span>学院代码：</span>
          <Input v-model="value" placeholder="请输入学院代码" style="width: 193px;margin-left:30px;" />
          <p style="margin-top:19px;"></p>
          <span style="color:red;">*</span>
          <span>学院负责人：</span>
    ...
    <div class="xyxm" v-show="looks">
      <div class="topxyxm">
        <div class="titlex">学院信息</div>
        <div class="linex"></div>
        <div style="margin-top:36px;font-size:14px;margin-left:3px">
          <span>学院名称：</span>
          <span style="margin-left:60px;font-weight:600;">{{model1}}</span>
        </div>
        <div style="margin-top:36px;font-size:14px;margin-left:3px">
          <span>学院代码：</span>
          <span style="margin-left:60px;font-weight:600;">{{model1}}</span>
        ...
        <div style="margin-top:36px;font-size:14px;margin-left:3px">
          <span>学院负责人：</span>
          <span style="margin-left:46px;font-weight:600;">{{model1}}</span>
        </div>
...
export default {
  ...
  methods: {
    getList() {
      this.$post(gasDataList, this.page).then(result => {
        debugger;
